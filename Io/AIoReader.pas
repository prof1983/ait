...
Prototype: java.io.Reader (1.27 03/12/19)
}
unit AIoReader;
...
type
  ...
  TJavaIOReader = class //implements Readable, Closeable
    {
    ...
    *)
    ...
    procedure mark(readAheadLimit: Integer);
...
procedure TJavaIOReader.mark(readAheadLimit: Integer);
begin
...
function TJavaIOReader.ReadInt(): Integer;
begin
  Result := 0;
