{*
@Abstract(AIoRandomAccessFile)
@Author(Prof1983 prof1983@ya.ru)
@Created(25.04.2007)
@LastMod(27.04.2012)
@Version(0.5)

Prototype: java.io.RandomAccessFile (1.78 04/05/13)
}
unit AIoRandomAccessFile;
 ...
 * @since   JDK1.0
  ...
  TRandomAccessFile = class //public class RandomAccessFile implements DataOutput, DataInput, Closeable
  private
