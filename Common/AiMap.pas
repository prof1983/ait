...
type
  ...
  IJavaMap = interface //<K,V>
    ...
    function ContainsKey(key: IUnknown): Boolean;
    ...
    function ContainsValue(Value: IUnknown): Boolean;
    ...
    function Put(Key, Value: IUnknown): IUnknown;
    //V put(K key, V value);
    ...
    function Remove(Key: IUnknown): IUnknown;
    //V remove(Object key);
...
//    function SetValue(value: IUnknown): IUnknown;
	//V setValue(V value);
