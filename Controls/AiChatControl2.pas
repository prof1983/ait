...
type //** @abstract(Пример программы чат-бот: Окно для агента чат-бот)
  TAIChatControl = class(TMessagesMemoControl)
  protected
...
function TAIChatControl.DoMessageAdd(const AMessage: WideString; AID: Integer): Integer;
var
...
begin
  ...
  I := Pos(SInLow, 'привет');
  if I > 0 then begin // Во в ходной строке есть слово "привет"
    I := Random(6);
    case I of
      0: SOut := 'Здоровеньки';
      1: SOut := 'Привет';
