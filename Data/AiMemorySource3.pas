...
unit AiMemorySource3;

interface

uses
  AConsts2, ATypes,
  AiBase, AiFrameImpl, AiIntf, AiSourceImpl;

type //** @abstract(Источник знаний в памяти)
  TAIMemorySource3 = class(TAiSource)
  private
...
function TAIMemorySource3.Clear(): WordBool;
var
  I: Int32;
begin
...
procedure TAIMemorySource3.DoCreate();
var
  I: Int32;
begin
  inherited DoCreate();
...
procedure TAIMemorySource3.Free();
var
  I: Int32;
begin
...
function TAIMemorySource3.Get_FrameByID(ID: TAIID): IAIFrame;
begin
...
function TAIMemorySource3.Initialize(): TProfError;
begin
